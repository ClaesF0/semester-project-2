...
let apiUrl =
  "https://nf-api.onrender.com/api/v1/auction/listings?&_active=true&"; //default setting should be active stuff
...
selectFilterElement.addEventListener("change", function () {
  ...
  if (selectedEndpoint === "all" || undefined) {
    apiUrl =
      "https://nf-api.onrender.com/api/v1/auction/listings?&_active=true&";
  } else {
